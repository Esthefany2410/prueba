const preguntas = [
    {
        pregunta: "¿Qué elemento químico es el más abundante en el cuerpo humano por su masa?",
        respuestas: ["Cromo", "Selenio", "Escandio", "Manganeso"],
        correcta: 1
    },
    {
        pregunta: "¿Cuánto dura un año en el planeta Urano?",
        respuestas: ["4331.0 dias", "687.0 dias", "30589.0 dias", "10747.0 dias"],
        correcta: 2
    },
    {
        pregunta: "¿Qué satélite orbita el planeta Neptuno?",
        respuestas: ["Metone", "Mundilfari", "Náyade", "S/2000 J 11"],
        correcta: 2
    }
];
